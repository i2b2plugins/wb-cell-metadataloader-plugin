 ...
 * @author  wp066
 */
public class MetadataLoaderDisplayXmlMessageDialog extends javax.swing.JFrame {
	
    /** Creates new form OntologyDisplayXmlMessageDialog */
    public MetadataLoaderDisplayXmlMessageDialog(String msg) {
    ...
    public MetadataLoaderDisplayXmlMessageDialog(List<String> msgs) {
    ...
    private void initComponents() {
        ...
        java.awt.Image img = this.getToolkit().getImage(MetadataLoaderDisplayXmlMessageDialog.class.getResource("non-core-cell.gif"));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
            	String empty = null;
                new MetadataLoaderDisplayXmlMessageDialog(empty).setVisible(true);
            }
        });
    }
